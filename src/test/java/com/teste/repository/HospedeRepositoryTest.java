...
class HospedeRepositoryTest {
	...
	void testGetAllRepository() {
		...
		Hospede hospede2 = new Hospede(null, "Julia Alberto",
				"julio@gmail.com",
				"(00)0000-0000");
	...
	void testUpdateHospede() {
		...
		Hospede saveHospede = hospedeRepository.findById(hospede1.getId()).get();
		hospede1.setNome("Josué");
		hospede1.setEmail("josuegameplays@gmail.com");
		
		Hospede updateHospede = hospedeRepository.save(saveHospede);

		//Then /Assert
		assertNotNull(updateHospede);
		assertEquals("Josué", updateHospede.getNome());
		assertEquals("josuegameplays@gmail.com", updateHospede.getEmail());
	}
